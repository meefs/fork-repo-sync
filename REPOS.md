...
- [meefs/colibri](https://github.com/meefs/colibri): Run GLM-5.2 (744B MoE) on a 25GB-RAM consumer machine — pure C, zero deps, experts streamed from disk. Tiny engine, immense model. 🐦
...
- [meefs/anime](https://github.com/meefs/anime): JavaScript animation engine
- [meefs/awesome-gpt4o-images](https://github.com/meefs/awesome-gpt4o-images): Awesome curated collection of images and prompts generated by GPT-4o and gpt-image-1. Explore AI generated visuals created with ChatGPT and Sora, showcasing OpenAI’s advanced image generation capabilities.
...
- [meefs/claude-yank-patcher](https://github.com/meefs/claude-yank-patcher): tool to patch versions of claude-code to add ^Y (yank) functionality. 
...
- [meefs/gemma-cookbook](https://github.com/meefs/gemma-cookbook): A collection of guides and examples for the Gemma open models from Google.
...
- [meefs/nano-banana-hackathon-kit](https://github.com/meefs/nano-banana-hackathon-kit): 🍌 The official starter kit for the Nano Banana Hackathon. Clone this repo to get building fast!
...
- [meefs/Substrates](https://github.com/meefs/Substrates): Code, prompts, protocols, and reproducibility materials for Substrates.
...
- [meefs/TimeSlice-Nodes](https://github.com/meefs/TimeSlice-Nodes): Temporal slit-scan / time-displacement effects for ComfyUI — angled, animated and dual-source slicing on a shared engine.
...
- [meefs/claude-ads](https://github.com/meefs/claude-ads): Comprehensive paid advertising audit & optimization skill for Claude Code. 250+ checks across Google, Meta, YouTube, LinkedIn, TikTok, Microsoft & Apple Ads with weighted scoring, parallel agents, industry templates, and AI creative generation.
...
- [meefs/ecdsa-private-key-recovery](https://github.com/meefs/ecdsa-private-key-recovery): A simple library to recover the private key of ECDSA and DSA signatures sharing the same nonce k and therefore having identical signature parameter r
...
- [meefs/site-scanning-analysis](https://github.com/meefs/site-scanning-analysis): Analysis reports for the Site Scanning program
- [meefs/skills](https://github.com/meefs/skills): Public repository for Skills
...
- [meefs/superpowers](https://github.com/meefs/superpowers): An agentic skills framework & software development methodology that works.
...
## Swift
- [meefs/ClaudeBar](https://github.com/meefs/ClaudeBar): A macOS menu bar application that monitors AI coding assistant usage quotas. Keep track of your Claude, Codex, Antigravity ,and Gemini usage at a glance.
...
- [meefs/chipotle-llm-provider](https://github.com/meefs/chipotle-llm-provider): OpenAI-compatible LLM proxy backed by Chipotle's Pepper AI (IPsoft Amelia) — free inference via fast food
...
- [meefs/flounder](https://github.com/meefs/flounder): Autonomous white-hat security auditor
...
- [meefs/shaders](https://github.com/meefs/shaders): Zero-dependency canvas shaders that can be installed from npm or designed in Paper
...
- [meefs/Immunefi-bug-bounty-writeups-list](https://github.com/meefs/Immunefi-bug-bounty-writeups-list): curation of all(most) immunefi bug bounty writeups I could find(till now)
